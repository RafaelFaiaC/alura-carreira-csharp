...
int vidas = 5;
Console.WriteLine($"Você cometeu um erro e perdeu uma vida! Vida atual: {--vidas}");
Console.WriteLine($"Você acertou e ganhou uma vida extra! Vida atual: {++vidas}");
Console.WriteLine($"Você acertou e ganhou uma vida extra! Vida atual: {++vidas}");
Console.WriteLine($"Fim de jogo! Você terminou o jogo com {vidas} vidas");