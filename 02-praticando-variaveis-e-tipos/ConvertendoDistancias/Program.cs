...
Console.Write("Informe quantas milhas deseja fazer a conversão: ");
float distanciaEmMilhas = float.Parse(Console.ReadLine()!);
float distanciaEmQuilometros = (distanciaEmMilhas * 1.60934f);
